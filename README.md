...
* [Выделение](#выделение)
* [Операторы OR и AND](#операторы-or-и-and)
* [Сортировка](#сортировка)
* [Добавление](#добавление)
* [Обновление/Замена](#обновлениезамена)
* [Удаление](#удаление)
* [Создание таблицы](#создание-таблицы)
* [Удаление таблицы](#удаление-таблицы)
* [Типы данных](#типы-данных)
* [Кавычки и перенос строк](#кавычки-и-перенос-строк)
* [Cтроковые типы со значениями которые выбираются из фиксированного списка значений](#строковые-типы-со-значениями-которые-выбираются-из-фиксированного-списка-значений)
* [Уникальные строки/Исключение дубликатов](#уникальные-строкиисключение-дубликатов)
* [Фильтрация строк после группировки (Having)](#фильтрация-строк-после-группировки-having)
* [Объединение строки из двух или более таблиц на основе связующего столбца между ними (Join)](#объединение-строки-из-двух-или-более-таблиц-на-основе-связующего-столбца-между-ними-join)
* [primary key и primary key auto_increment](#primary-key-и-primary-key-auto_increment)
